...
import CourseSelectionPage from '../Course/CourseSelectionPage';  // Import the new page
import CoursePage from '../Course/CoursePage';
import AssignmentMangement from '../Assignment/AdminAssignmentPage';
...
/>
   ...
   <Route path="/course/:courseId" element={isAuthenticated() ? <CoursePage /> : <Navigate to="/" />} />
   {/* <Route path="/assignments" element={isAuthenticated() ? <AssignmentMangement /> : <Navigate to="/" />} /> */}
   <Route
          path="/assign-task"
